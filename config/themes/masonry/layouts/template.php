...
<head>
	...
	<?php
		...
		$gallery_link_hover_color			= SubfolioTheme::get_color('gallery_link_hover'     , $back_color);
		$gallery_back_color						= SubfolioTheme::get_color('gallery_back'     			, $main_link_back_hover_color);
		$gallery_back_hover_color			= SubfolioTheme::get_color('gallery_back_hover'     , $main_link_hover_color);
	...
	<script src="<?php echo SubfolioTheme::get_view_url(); ?>/js/jquery.masonry.1.3.1.min.js"></script>
