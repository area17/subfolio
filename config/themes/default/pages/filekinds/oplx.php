<div id="download_box">
  ...
  <a id="clickable-zone" href="<?php echo Subfolio::current_file('archive') ?>" target="<?php echo Subfolio::current_file('target') ?>">
  ...
  <a id="download" href="<?php echo Subfolio::current_file('archive') ?>?download=true" target="<?php echo Subfolio::current_file('target') ?>" download><?php echo SubfolioLanguage::get_text('downloadzip') ?></a>
